...
const Product = () => {
  const { id } = useParams();
  const viewedData = localStorage.getItem("viewed")
  ...
  return (
    <div className="w-full h-full mt-16 mb-48 max-lg:mb-16">
      <div className="h-full w-full flex justify-center max-lg:flex-col max-lg:justify-start max-lg:items-center max-sm:px-2">
        <div className="w-4/12 max-lg:w-8/12 max-sm:w-full">
          <img
        ...
        <div className="w-4/12 max-lg:w-8/12 max-sm:w-full flex flex-col items-start pl-32 max-lg:p-0">
          <div className="capitalize text-2xl mb-4 max-lg:text-center">
            name
          </div>
          ...
          <button className="bg-black text-white border-2 w-full py-1 text-center mt-4 mb-8">
            Add to bag
          </button>
          <div className="mb-6 capitalize">
            ...
            <div>
              ...
              veniam ipsa itaque saepe debitis. Aperiam non fugit vitae eligendi
              totam rem! Eius qui earum optio quam suscipit. Ipsam, atque
              cupiditate.
            </div>
          </div>
