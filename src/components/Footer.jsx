        ...
        <div className="w-full bg-gray-100 flex justify-between flex-col items-center h-fit pt-4">
            ...
            <div className="max-md:w-screen flex w-6/12 justify-around text-center mt-4">
                <div className="w-4/12 h-14 overflow-hidden text-center flex justify-center items-center">
                    <select defaultValue="en" className="w-8/12 bg-transparent text-center">
                        <option value="en">English</option>
                        <option value="ru">Russian</option>
                    </select>
                </div>
                <div className="w-4/12 h-14 overflow-hidden text-center flex justify-center items-center"><img src='https://freepngimg.com/thumb/categories/1394.png' className='h-20' alt='' /> </div>
            ...
            <div className="mt-6 w-full text-center bg-gray-200">© All rights reserved by Tstore {currentYear}</div>
        </div>
    );
};
