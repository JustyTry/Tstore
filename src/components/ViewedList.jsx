...
const ViewedList = () => {
    ...
    return (
        <div className={`${localStorage.getItem("viewed") ? "w-full h-80 bg-gray-200 mb-24 flex  flex-col items-center" : "hidden"}`}>
